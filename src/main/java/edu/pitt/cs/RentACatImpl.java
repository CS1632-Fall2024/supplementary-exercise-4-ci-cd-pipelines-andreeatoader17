...
public class RentACatImpl implements RentACat {
	...
	public boolean returnCat(int id) {
		...
		{
			cat.returnCat();
			return true; // true if cat exists and is rented 
		}
		return false;
	}
	...
	public boolean rentCat(int id) {
		...
		{
			cat.rentCat();
			return true; // true if cat exists and is not rented 
		}
		return false;
	}
	...
	public String listCats() {
		// TODO: Fill in
		StringBuilder listCat = new StringBuilder();
		for (Cat cat: cats)
		{
			if (!cat.getRented())
			{
				listCat.append(cat.toString());
				listCat.append("\n");
			}
		}
